      ...
      <div class="col-12 col-md-5 py-0 py-md-4 py-xxl-5">
        <div class="card radius-default shadow py-3 px-3 px-lg-5">
          <div class="card-body text-center">
            ...
            <h5 class="fw-semibold mt-4">Anda akan beralih menjadi Researcher</h5>
            <div class="col d-flex justify-content-between mt-3">
              ...
              <a class="btn btn-orange radius-default w-100" href="{{ route('change.researcher') }}">Konfirmasi</a>
            </div>
          </div>
        </div>
      </div>
