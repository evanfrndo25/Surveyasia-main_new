...
{{-- Pre Survey --}}
<!-- Awalan -->
<section class="pre-survey p-5 d-none" id="pre-survey">
    ...
    <div class="container shadow p-3 radius-default">
        ...
        <div class="row">
            <div class="col">
                <div class="card border radius-default mt-3">
                    <div class="card-body">
                        <p class="text-success">Terimakasih karena sudah mengisi survey <span class="fw-bold">{{ $survey->title }}</span></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row pt-4 pb-2 mx-1 mb-3">
            @can('verifiedByAdmin')
                ...
                @endif
            @elsecannot('verifiedByAdmin')
                    <button type="button" class="btn btn-secondary w-100" data-bs-toggle="modal" data-bs-target="#alert-modal-unverified">
                        Mulai
                    </button>
            @endcan
        </div> -->
