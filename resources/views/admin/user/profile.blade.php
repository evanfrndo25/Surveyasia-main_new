    ...
    <div class="row">
        ...
        <div class="col-10 nopadding">
            ...
            <div class="container mt-4">
                ...
                <div class="container ">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('admin.users.index') }}" class="mb-2 text-dark h6 text-decoration-none">
            ...
            <div class="card border-0 bg-white p-3" style="border-radius: 20px;">
                <nav class="user-tabs">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link text-secondary" id="survey-tab" data-bs-toggle="tab" data-bs-target="#survey"
                            type="button" role="tab" aria-controls="survey" aria-selected="false">Survei</button>
                        <button class="nav-link text-secondary" id="transaksi-tab" data-bs-toggle="tab" data-bs-target="#transaksi"
                             type="button" role="tab" aria-controls="transaksi" aria-selected="false">Transaksi</button>
                    </div>
                </nav>
            </div>
        </br>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="biodata" role="tabpanel" aria-labelledby="biodata-tab">
                ...
                <nav class="user-tabs">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active text-secondary" id="kontak-tab" data-bs-toggle="tab"
                            data-bs-target="#kontak" type="button" role="tab" aria-controls="kontak"
                            aria-selected="true">Biodata</button>
                        <button class="nav-link text-secondary" id="data-tab" data-bs-toggle="tab" data-bs-target="#data"
                            type="button" role="tab" aria-controls="data" aria-selected="false">Data Pribadi</button>
                    </div>
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="kontak" role="tabpanel" aria-labelledby="kontak-tab">
                            <div class="col-1 text-center">
                                <br>
                                <p class=" text-center " style="fw-bold; font-size: 13px;">Foto Profil</p>
                                    <img src="{{ asset('assets/img/photo-neil-seims.jpg') }}" alt="Profile Picture" 
                                    width="70" height="70" class="d-block mb-2 rounded-pill profile-picture-preview object-fit-cover">
                            </div>
                            <br>
                            <div class="col-1 text-center">
                                <ins class=" text-center " style="fw-bold; font-size: 16px;">Kreator</ins>
                            </div>
                            </br>
                            <div class="row mb-3">
                                <div class="col-lg-9">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlInput1"
                                        name="" disabled value="{{ $user->nama_lengkap }}">
                                </div>
                                <div class="col-lg-3">
                                    <label for="exampleFormControlInput1" class="form-label">ID</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput1"
                                        name="" disabled value="{{ $user->id}}">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Telepon</label>
                                <input type="text" class="form-control" id="exampleFormControlInput1"
                                    name="" disabled value="{{ $user->telp }}">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Email</label>
                                <input type="text" class="form-control" id="exampleFormControlInput1"
                                    name="" disabled value="{{ $user->email }}">
                            </div>
                            </div>
                                    ...
                                    <form action="{{ route('admin.users.update', $user->profile->id) }}" method="post">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control" id="kota" placeholder="Kode-pos"
            ...
            <div class="tab-pane fade" id="survey" role="tabpanel" aria-labelledby="survey-tab">
                ...
                <nav class="user-tabs">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active text-secondary" id="kontak-tab" data-bs-toggle="tab"
                            data-bs-target="#responden" type="button" role="tab" aria-controls="responden"
                            aria-selected="true">Responden</button>
                        <button class="nav-link text-secondary" id="researcher-tab" data-bs-toggle="tab" data-bs-target="#researcher"
                            type="button" role="tab" aria-controls="data" aria-selected="false">Researcher</button>
                    </div>
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="responden" role="tabpanel" aria-labelledby="responden-tab">
                            <div class="card border-0 bg-white p-10" style="border-radius: 20px;">
                                <div class="container pt-4">
                                    <table id="hempas" class="table table-no-border-head align-middle" style="border-radius: 0px; overflow: hidden; background-color:#ffffff">
                                        <thead style="background-color:#f6beb226;">
                                            <tr class="fw-bold">
                                                <td scope="col" class="text-left align-middle">No</td>
                                                <td scope="col" class="text-left align-middle">Survey</td>
                                                <td scope="col" class="text-left align-middle">Kreator</td>
                                                <td scope="col" class="text-left align-middle">Waktu</td>
                        ...
                        <div class="tab-pane fade" id="researcher" role="tabpanel" aria-labelledby="researcher-tab">
                        <div class="card border-0 bg-white p-10" style="border-radius: 20px;">
                                <div class="container pt-4">
                                    <table id="hempas" class="table table-no-border-head align-middle" style="border-radius: 0px; overflow: hidden; background-color:#ffffff">
                                        <thead style="background-color:#f6beb226;">
