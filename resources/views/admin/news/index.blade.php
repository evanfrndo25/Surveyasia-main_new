                ...
                <tr style="background-color: #F7FAFC;">
                  ...
                  <td scope="col" class="text-end pe-3">
                    ...
                    <ul class="dropdown-menu"
                      ...
                      <li><a class="dropdown-item" href="{{ route('admin.news.show',$item->slug) }}">Show</a></li>
                      <li>
                      <li><a class="dropdown-item" href="{{ route('admin.news.edit',$item->slug) }}">Edit </a></li>
                      <li>
                        <form
              ...
              <div class="col">
                <form method="post" enctype="multipart/form-data" id="form-edit">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="my-editor form-control editor-desc" id="my-editor"
