    ...
    <div class="row border">
        ...
        <div class="col-10 nopadding">
            ...
            <div class="container mt-2">
                ...
                @endif
                <div class="card"
                    style="background-color: #FFFFFF; border: 1px solid rgba(0, 0, 0, 0.3); border-radius: 20px; padding:30px;">
                    <form action="{{ route('admin.chart.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center text-center">
                            <div class="col-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select py-3 px-3  @error('library_from') is-invalid @enderror"
                                        id="library_from" name="library_from" onchange="changeChartType()">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select py-3 px-3  @error('type') is-invalid @enderror" id="type"
                                        name="type">
                                        <option value=""></option>
                                    </select>
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="deskripsi"
                                placeholder="Tulis disini..." rows="3" name="description"></textarea>
                            @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
