        ...
        <div class="col-10 nopadding">
            ...
            <div class="container pt-4 mb-5">
                ...
                <form action="{{ route('admin.chart.update', $chart->id) }}" method="post"
                    ...
                    @csrf
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Chart</label>
                        <input type="text" name="chart" class="form-control" id="exampleFormControlInput1"
                            value="{{ $chart->chart }}">
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Jenis</label>
                        <select class="form-select border-r-besar" aria-label="Default select example" name="jenis">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select border-r-besar" aria-label="Default select example" name="aktivitas">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select border-r-besar" aria-label="Default select example" name="status">
                            @if ($chart->status == '0')
