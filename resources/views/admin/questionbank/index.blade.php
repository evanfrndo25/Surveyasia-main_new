...
@section('content')
  ...
  <div class="container-fluid">
          ...
          <table class="table table-no-border-head align-middle">
            <thead>
              <tr class="fw-bold">
                ...
                <td class="text-end">
                  <a href="" class="btn bg-special-blue text-white"
            ...
            <tbody>
              ...
              @foreach ($questionbank_sub_templates_act as $item)
                ...
                <tr>
                  ...
                  @else
                  <td><a href="{{url('/admin/questionbank', ['id'=>$item])}}" class="sub" >{{ $item->sub_template_name }}</a></td>
                          ...
                          <form id="edit-form" class="form-horizontal" method="POST" action="">
                                ...
                                <li>
                                  ...
                                  data-id="{{ $item->id }}">Edit </a> --}}
                                    <a class="dropdown-item" href="{{route('admin.questionbank.edit',['questionbank' => $item->id])}}">Edit </a>
                                </li>
                  ...
                  {{-- <td class="text-end"><a href="{{ route('admin.questionbank.show', $item->id) }}" class="btn bg-special-blue text-white">
                            <i class="bi bi-vector-pen me-"></i>
                            Detail</a>
                        </td> --}}
                </tr>
    ...
    <div class="modal fade" id="modal-add-sub-template" tabindex="-1"
                  ...
                  <form method="post" enctype="multipart/form-data" id="form-add">
                    ...
                    <div class="mb-3">
                      ...
                      <textarea class="form-control border-r-besar"
                        id="description" rows="3" name="goals"></textarea>
                    </div>
                </div>
              </div>
            </div>
