        ...
        <div class="row">
            ...
            <div class="col-10 nopadding">
                ...
                <div class="container pt-4">
                    ...
                    @endif
                    <a href="{{ route('admin.questionbank.index') }}" class="btn btn-danger mb-2">
                        <-Back </a>
                            <h3>{{ $questionbank->sub_template_name }}</h3>
          ...
          @endforeach --}}
                            <hr>
                            <p class="fw-bold">All Question</p>
                            <!-- @php
                                $no = 1;
                            @endphp
                ...
                <div class="card mb-3 text-center fade" id="noQuestionContainer" style="height: 100%">
                    <div class="card-body">
                        ...
                        <button type="button" id="btnAddQuestion" class="btn btn-sm btn-default text-white">Buat
                            Pertanyaan</button>
                    </div>
                </div>
