                                ...
                                <div class="col-md-4 mt-md-0 mt-3">
                                    <div class="border radius-muted p-3">
                                        ...
                                        <a class="btn btn-outline-dark radius-muted w-100 fw-semibold mb-3"
                                            href="{{ route('payment') }}" role="button">Choose this plan</a>
                            ...
                            <div class="row justify-content-center business-price" id="business-price">
                                <div class="col-md-4 mt-md-0 mt-3">
                                    <div class="border radius-muted p-3">
                                        ...
                                        <h4 class="fw-bold">Rp{{ number_format($categorySubscription[6]->price, 0,
                                            0,
                                            '.') }}</h4>
                                        <p class="text-secondary fs-14px">Per bulan</p>
                                        <a class="btn btn-outline-dark radius-muted w-100 fw-semibold mb-3"
                    ...
                    <div class="tab-pane fade show active" id="personal-yearly" role="tabpanel"
                        ...
                        <div class="container">
                            <div class="row justify-content-center personal-yearly-price" id="personal-yearly-price">
                                <div class="col-md-4 mt-md-0 mt-3">
                                    <div class="border radius-muted p-3">
                                        <h5 class=" fw-bold">Essential Annual</h5>
                                        <p class="fs-14px">For early-stage start-ups. Your first step towards,
                                            building a brand.</p>
                                ...
                                <div class="col-md-4 mt-md-0 mt-3">
                                    <div class="border radius-muted p-3">
                                        <h5 class=" fw-bold">Plus Annual</h5>
                                        <p class="fs-14px">Ideal for professionals. Meet all your survey requirements
                                            at once.</p>
