...
<!-- New Design -->
<div class="container-fluid my-0" id="clock">
    <div class="row">
        <div class="col">
            <nav>
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <img src="{{ asset('storage/' . \Auth::user()->avatar) }}"
                                value="{{ asset('storage/' . \Auth::user()->avatar) }}" class="w-25 mb-2" alt="">
                            <div class="card">
                                <div class="card-body">
                                    <div class="container">
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col" id="btnContainer">
                                                        <button type="button" class="btn btn-outline-orange"
                                                            id="prevBtn"><i class="bi bi-chevron-left"></i>
                                                            Sebelumnya</button>
                                                    </div>
                                                ...
                                                <div class="row justify-content-center my-3">
                                                    <div class="col-md-8 text-center">
                                                        ...
                                                        <p class="py-3">Anda telah menyelesaikan survey<span
                                                                class="fw-semibold"> {{ $survey->title }} </span></p>
