        ...
        <div class="modal-content">
                            ...
                            <div class="row justify-content-center text-center">
                                ...
                                <div class="col-md-9">
                                    <p class="text-secondary">Setting up an investment structure, raiding the neccessary
                                        capital, and maintaing an excellent investor relation throught the investment
                                        life requires well-established processes
                                    </p>
                                </div>
                                <div class="d-flex justify-content-center">
                                    ...
                                    <div class="form-check form-switch ms-2">
                                        <input class="form-check-input form-check-input-orange" type="checkbox"
                                            id="pricingSwitch" onchange="pricingSwitch()">
                                    </div>
                            ...
                            <div class="monthly-pricing" id="monthlyPricing">
                                <ul class="nav justify-content-center mb-3" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link link-pricing link-secondary" aria-current="page" href="#"
                                            ...
                                            data-bs-target="#pay-per-survey" type="button" role="tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link link-pricing link-secondary" aria-current="page" href="#"
                                            id="business-tab" data-bs-toggle="tab" data-bs-target="#business"
                                            type="button" role="tab" aria-controls="business" aria-selected="true">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade" id="pay-per-survey" role="tabpanel"
                                        ...
                                        <div class="container">
                                            <div class="row justify-content-center pay-per-survey-price"
                                                id="pay-per-survey-price">
                                                <div class="col-md-4 mt-md-0 mt-3">
                                                    <div class="border radius-default p-3">
                                                        <h5 class=" fw-bold">{{ $categorySubscription[1]->title }}</h5>
                                                        <p class="fs-14px">{{ $categorySubscription[1]->description }}
                                                        </p>
                                                        <h4 class="fw-bold">Start from Rp{{
                                                            number_format($categorySubscription[1]->price, 0, 0, '.') }}
                                                        </h4>
                                                ...
                                                <div class="col-md-4 mt-md-0 mt-3">
                                                    <div class="border radius-default p-3">
                                                        ...
                                                        <p class="fs-14px">{{ $categorySubscription[2]->description }}
                                                        </p>
                                                        <h4 class="fw-bold">Contact us for custom pricing</h4>
                                                        <p class="text-secondary fs-14px">Per bulan</p>
                                                        <a class="btn btn-outline-dark radius-default w-100 fw-semibold mb-3"
                                                            href="{{ route('contact.index') }}" role="button">Choose
                                                            this plan</a>
                                                        <div class="text-secondary">
                                                            <p>&#10004; Kolaborasi Tim</p>
                                                            <p>&#10004; Custom</p>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                @for ($i = 0; $i < 5; $i++) <p class="text-muted">
                                                                    &#10004;</p>
                                                                    @endfor
                                                            </td>
                                                            <td>
                                            ...
                                            <div class="row justify-content-center personal-price" id="personal-price">
                                                <div class="col-md-4 mt-md-0 mt-3">
                                                    <div class="border radius-default p-3">
                                                        ...
                                                        <p class="fs-14px">{{ $categorySubscription[3]->description }}
                                                        </p>
                                                        <h4 class="fw-bold">Rp{{
                                                            number_format($categorySubscription[3]->price, 0, 0,
                                                            '.') }}</h4>
                                                        <p class="text-secondary fs-14px">Per bulan</p>
                                                        <a class="btn btn-outline-dark radius-default w-100 fw-semibold mb-3"
                                                ...
                                                <div class="col-md-4 mt-md-0 mt-3">
                                                    <div class="border radius-default p-3">
                                                        ...
                                                        <p class="fs-14px">{{ $categorySubscription[4]->description }}
                                                        </p>
                                                        <h4 class="fw-bold">Rp{{
                                                            number_format($categorySubscription[4]->price, 0, 0,
                                                            '.') }}</h4>
                                                        <p class="text-secondary fs-14px">Per bulan</p>
                                                        <a class="btn btn-outline-dark radius-default w-100 fw-semibold mb-3"
                                                ...
                                                <div class="col-md-4 mt-md-0 mt-3">
                                                    <div class="border radius-default p-3">
                                                        ...
                                                        <p class="fs-14px">{{ $categorySubscription[5]->description }}
                                                        </p>
                                                        <h4 class="fw-bold">Rp{{
                                                            number_format($categorySubscription[5]->price, 0, 0,
                                                            '.') }}</h4>
                                                        <p class="text-secondary fs-14px">Per bulan</p>
                                                        <a class="btn btn-outline-dark radius-default w-100 fw-semibold mb-3"
                                            ...
                                            <div class="row justify-content-center business-price" id="business-price">
                                                <div class="col-md-4 mt-md-0 mt-3">
                                                    <div class="border radius-default p-3">
                                                        ...
                                                        <p class="fs-14px">{{ $categorySubscription[6]->description }}
                                                        </p>
                                                        <h4 class="fw-bold">Rp{{
                                                            number_format($categorySubscription[6]->price, 0,
                                                            0,
                                                            '.') }}</h4>
                                                        <p class="text-secondary fs-14px">Per bulan</p>
                                                        <a class="btn btn-outline-dark radius-default w-100 fw-semibold mb-3"
                                                ...
                                                <div class="col-md-4 mt-md-0 mt-3">
                                                    <div class="border radius-default p-3">
                                                        ...
                                                        <p class="fs-14px">{{ $categorySubscription[7]->description }}
                                                        </p>
                                                        <h4 class="fw-bold">Rp{{
                                                            number_format($categorySubscription[7]->price, 0, 0,
                                                            '.') }}</h4>
                                                        <p class="text-secondary fs-14px">Per bulan</p>
                                                        <a class="btn btn-outline-dark radius-default w-100 fw-semibold mb-3"
                                                ...
                                                <div class="col-md-4 mt-md-0 mt-3">
                                                    <div class="border radius-default p-3">
                                                        ...
                                                        <p class="fs-14px">{{ $categorySubscription[8]->description }}
                                                        </p>
                            ...
                            <div class="yearly-pricing d-none" id="yearlyPricing">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="personal-yearly" role="tabpanel"
                                        ...
                                        <div class="container">
                                            <div class="row justify-content-center personal-yearly-price"
                                                id="personal-yearly-price">
                                                <div class="col-md-4 mt-md-0 mt-3">
                                                    <div class="border radius-default p-3">
                                                        <h5 class=" fw-bold">{{ $categorySubscription[6]->title }}</h5>
                                                        <p class="fs-14px">{{ $categorySubscription[6]->description }}
                                                        </p>
                                                        <h4 class="fw-bold">Rp{{ number_format(2388000, 0, 0,
                                                            '.') }}</h4>
                                                ...
                                                <div class="col-md-4 mt-md-0 mt-3">
                                                    <div class="border radius-default p-3">
                                                        ...
                                                        <h4 class="fw-bold">Rp{{ number_format(5388000, 0, 0,
                                                            '.') }}</h4>
                                                        <p class="text-secondary fs-14px">Per tahun</p>
                                                        <a class="btn btn-outline-dark radius-default w-100 fw-semibold mb-3"
                                                            href="{{ route('researcher.payment.show', $categorySubscription[7]) }}"
            ...
            <div class="modal-footer justify-content-start">
                <div class="form-check">
                    <input type="checkbox" class="form-check-input form-check-input-orange" id="hidePricing">
                    <label class="form-check-label text-muted" for="hidePricing">Jangan tampilkan lagi</label>
                </div>
            </div>
        </div>
    </div>
