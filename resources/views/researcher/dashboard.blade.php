...
@section('content')
    ...
    <div class="container-fluid p-3 p-md-5">
        ...
        <div class="row">
            <div class="col">
                {{-- Modal Button --}}
                <button type="button" class="btn btn-orange" data-bs-toggle="modal" data-bs-target="#addSurveyModal"><i class="fas fa-plus fa-fw"></i>
                    Survey Baru</button>
            </div>
            <div class="col-md-3 mt-3 mt-md-0">
                <form>
                    <div class="input-group">
                        ...
                        <button class="btn btn-orange" id="btnNavbarSearch" type="button"><i class="bi bi-search"></i></button>
                    </div>
                </form>
            </div>
        </div>
