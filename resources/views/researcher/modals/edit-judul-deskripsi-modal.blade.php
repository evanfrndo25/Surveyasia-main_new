            ...
            <div class="row mb-3">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <div class="container">
                                <input type="text" name="title" class="form-control" value="{{ $survey->title }}" style="color: #00000099; font-size:24px;"></input>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="container mt-4">
                            ...
                            <div class="mb-3 mt-3">
                                <textarea type="text" name="description" value="{{ $survey->description }}" class="form-control"
