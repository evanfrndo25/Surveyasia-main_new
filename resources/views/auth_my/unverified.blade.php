                ...
                <div class="card radius-default shadow py-3 px-3 px-lg-5">
                    <div class="card-body text-center">
                        <img src="{{ asset('assets/img/email_verify.png') }}" alt="Surveyasia" width="300"
                            class="img-fluid">
                        <h4 class="fw-semibold mt-4">Email Anda Belum Diverifikasi</h4>
                        <p class="mt-3 mb-1">Hai <span class="fw-semibold">{{ Auth::user()->nama_lengkap }}</span>!
                            Tautan verifikasi telah dikirim, mohon cek email Anda.
                        </p>
                        <p class="text-muted fs-14px">Jika tidak menerima email dari Surveyasia, gunakan tombol di bawah
