...
class LoginController extends Controller
{
    ...
    */
    ...
    public function showLoginForm(Request $request)
    {
        ...
        return view('auth_my.login', ['share' => $fromShareLink]);
    }
    ...
    protected function sendLoginResponse(Request $request)
    {
        ...
        // specify where to redirect after login based on user's role
        if ($this->guard()->user()->role_id == Role::IS_RESEARCHER)
            $this->redirectTo = 'researcher/surveys';
        if ($this->guard()->user()->role_id == Role::IS_RESPONDENT)
            $this->redirectTo = 'respondent/dashboard';
